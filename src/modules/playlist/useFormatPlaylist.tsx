...
export function usePlaylistTitleDesc(playlist: PlaylistLike | undefined) {
  ...
  const rawTitle = formatPlaylist("title", playlist, { t, tn });
  const rawDescription = formatPlaylist("description", playlist, { t, tn });
  ...
  if (process.env.NODE_ENV === "development") {
    if (rawTitle !== undefined && typeof rawTitle !== "string") {
      ...
      console.warn("[usePlaylistTitleDesc] Non-string title", {
    ...
    if (rawDescription !== undefined && typeof rawDescription !== "string") {
      // eslint-disable-next-line no-console
      console.warn("[usePlaylistTitleDesc] Non-string description", {
        playlistId: (playlist as any).id,
        rawDescription,
      });
    }
